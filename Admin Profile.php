  ...
  <fieldset>
    <h2 class="fs-title">Personal Information</h2>
	 ...
	 <!-- Begin What's Your First Name Field -->
        <div class="hs_firstname field hs-form-field">
          ...
          <label for="firstname-99a6d115-5e68-4355-a7d0-529207feb0b3_2983">Type</label>

          <input id="firstname-99a6d115-5e68-4355-a7d0-529207feb0b3_2983" name="type" readonly type="text" value="<?php echo $result['type']; ?>" placeholder="" data-rule-required="true" data-msg-required="Please include your Password" >
    ...
    <!-- Begin What's Your First Name Field -->
        <div class="hs_firstname field hs-form-field">
          ...
          <input id="firstname-99a6d115-5e68-4355-a7d0-529207feb0b3_2983" name="fname" required="required" type="text" value="<?php echo $result['name']; ?>" placeholder="" data-rule-required="true" data-msg-required="Please include your Full Name" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div> 
    ...
    <!-- Begin What's Your Email Field -->
        <div class="hs_email field hs-form-field">
          ...
          <input id="email-99a6d115-5e68-4355-a7d0-529207feb0b3_2983" name="email" readonly type="email" value="<?php echo $result['email']; ?>" placeholder="" data-rule-required="true" data-msg-required="Please enter a valid UOG Email" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- Begin What's Your Email Field -->
        <div class="hs_email field hs-form-field">
          ...
          <label for="email-99a6d115-5e68-4355-a7d0-529207feb0b3_2983">Password *</label>

          <input id="email-99a6d115-5e68-4355-a7d0-529207feb0b3_2983" name="password" required="required" type="text" value="<?php echo $result['password']; ?>" placeholder="" data-rule-required="true" data-msg-required="Please enter a valid UOG Email" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- End What's Your First Name Field -->
	   ...
	   <!-- Begin Total Number of Constituents in Your Database Field -->
        <div class="hs_email field hs-form-field hs_total_number_of_constituents_in_your_database">
          ...
          <input id="edit-submitted-constituent-base-total-constituents" class="form-text hs-input" name="contact" required="required" size="60" maxlength="128" type="number" value="<?php echo $result['contact']; ?>" placeholder="" data-rule-required="true" data-msg-required="Please enter a valid Contact No#" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- End Total Number of Constituents in Your Database Field -->
	   ...
	   <!-- Begin Total Number of Constituents in Your Database Field -->
        <div class="hs_email field hs-form-field hs_total_number_of_constituents_in_your_database">
          ...
          <input id="edit-submitted-constituent-base-total-constituents" class="form-text hs-input" name="address" required="required" size="60" maxlength="128" type="text" value="<?php echo $result['address']; ?>" placeholder="" data-rule-required="true" data-msg-required="Please enter a valid Address" >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- End Total Number of Constituents in Your Database Field -->
	  ...
	  <input type="submit" name="update" value="Update" class="next action-button" />
	  </form>
</fieldset>
...
<?php
	...
	if($_POST['update'])
	{
		...
		if($fname!="" && $email!="" && $pass!="" && $gender!="" && $contact!="" && $address!="")
		{
			$Query = "UPDATE ADMIN SET name = '$fname', password = '$pass', gender = '$gender', contact = '$contact', address = '$address' WHERE email = '$email'";
			...
			{
				echo ("<h4>Profile Failed to Update.</h4>");
			}
		}
		}
?>
