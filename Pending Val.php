		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section"><strong>Pending Donations</strong></h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
						...
						<table class="table table-striped">
						  ...
						  <tbody>
							  <?php
								...
								$User_status = "Pending from Volunteer";
								...
								?>
									<tr>
									  ...
									  <td><a href="Pending Val.php?rollno=<?php echo $data['id']; ?>" class="btn btn-success">Accept</a></td>
									  <td><a href="Pending Val.php?del=<?php echo $data['id']; ?>" class="btn btn-danger">Reject</a></td>
									</tr>
							<?php
										}
								}
							...
							{
							echo ("<h1> No Donation so for From Your Account <b>".$result['roll_no']."</b></h1>");
							}
							  ?>
						  </tbody>
						</table>
...
{
	$idr = $_GET['rollno'];
	$Query_Up="UPDATE Donations SET status = 'Received' where id=$idr";
	$data_up = mysqli_query($conn, $Query_Up);
	if($data_up)
	{
		echo ("<h2><b>Alhamdullilah..!</b></h2><br> You Gotted Help From Your Welfisher.");
	}
	else
	{
		echo ("Oops..!	Receiving Error..!");
	}
}
//------------------------------------------------------------------------------------------------
if(isset($_GET['del']))
