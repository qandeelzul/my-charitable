...
function calcTotal() {
    ...
    if (acqAmount1 > 0 && acqAmount2 > 0) {
        acqTotal = ((acqAmount2 * 100) / acqAmount1).toFixed(2);
    } else {
        acqTotal = 0;
    }
    ...
    if (cultAmount1 > 0 && cultAmount2 > 0) {
        cultTotal = ((cultAmount2 * 100) / cultAmount1).toFixed(2);
    } else {
        cultTotal = 0;
    }
    ...
    if (cultAmount3 > 0 && cultAmount4 > 0) {
        cultTotal2 = ((cultAmount4 * 100) / cultAmount3).toFixed(2);
    } else {
        cultTotal2 = 0;
    }
    ...
    if (retAmount1 > 0 && retAmount2 > 0) {
        retTotal = ((retAmount2 * 100) / retAmount1).toFixed(2);
    } else {
        retTotal = 0;
    }
