		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section"><strong>Volunteer List</strong></h2>
				</div>
			</div>
			<form method="GET">
			<div class="row">
				<div class="col-md-12">
					<div class="table-wrap">
						<h3>Total Volunteers <strong>(<?php echo $row ?>)</strong></h3>
						  ...
						  <tbody>			
							  ...
							  ?>
								<tr>
								  ...
								  <td><a href="View Approval.php?roll=<?php echo $result['roll_no'] ?>" class="btn btn-warning">Check</a></td>
								  <td><a href="Volunteer.php?del=<?php echo $result['roll_no'] ?>"><input type="button" class="btn btn-danger" value="Delete" /></a></td>
								</tr>
							  <?php
									}
							  ?>
...
{	
	...
	$Query_Del="DELETE From Volunteer WHERE roll_no = $roll_no";
